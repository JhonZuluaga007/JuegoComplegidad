...
namespace Canon.Controllers
{
    public class LauchingController : Controller
    {
        ...
        public ActionResult getVelocidad(int Id, int IdGamer, float Velocidad, float Angulo)
        {
            launching.Add(new Launching() { Id = Id, IdGamer = IdGamer, Angle = Angulo, Velocidad = Velocidad });
